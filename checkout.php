                                        ...
                                        <ul class=" list-unstyled">
                                            ...
                                            <!-- <li>
                                                <label class="custom-control custom-radio  m-b-10">
                                                    <input name="mod"  type="radio" value="paypal" disabled class="custom-control-input"> <span class="custom-control-indicator"></span> <span class="custom-control-description">Transfer <img src="images/paypal.jpg" alt="" width="90"></span> </label>
                                            </li> -->
                                        </ul>
                                        <p class="text-xs-center"> <input type="submit" onclick="return confirm('Apakah kamu ingin melanjutkan pemesanan ?');" name="submit"  class="btn btn-success btn-block" value="Pesan Sekarang"> </p>
                                    </div>
									</form>
                                </div>
                            </div>
