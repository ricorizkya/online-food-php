				...
				$fname = $_FILES['file']['name'];
									...
									if($fsize>=1000000)
										{
												...
												$error = 	'<div class="alert alert-danger alert-dismissible fade show">
																<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
																<strong>Ukuran gambar maksimal 1024kb!</strong> Coba gambar lainnya!.
															</div>';
					...
					elseif($extension == '')
					{
						$error = 	'<div class="alert alert-danger alert-dismissible fade show">
											...
											$error = 	'<div class="alert alert-danger alert-dismissible fade show">
																<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
																<strong>File bukan format gambar!</strong>Silahkan masukkan format png, jpg, Gif.
															</div>';
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right mailbox animated zoomIn">
                                <ul>
                                    ...
                                    <li>
                                        <a class="nav-link text-center" href="javascript:void(0);"> <strong>Semua Pembertitahuan</strong> <i class="fa fa-angle-right"></i> </a>
                                    </li>
                                </ul>
                            </div>
                        </li>
            ...
            <div class="container-fluid">
                        ...
                        <div class="card card-outline-primary">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Tambah Toko</h4>
                            </div>
                            <div class="card-body">
                                        ...
                                        <div class="row p-t-20">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group has-danger">
                                                    <label class="control-label">E-mail Toko</label>
                                            ...
                                            <div class="col-md-6">
                                             ...
                                             <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select name="c_hr" class="form-control custom-select" data-placeholder="Pilih Kategori" >
											 ...
											 <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select name="o_days" class="form-control custom-select" data-placeholder="Pilih Kategori" tabindex="1">
