                                ...
                                <div class="food-item">
                                    <div class="row">
										...
										<span class="price pull-left" >Rp. <?php echo $product['price']; ?></span>
										  ...
										  <input type="submit" class="btn theme-btn" style="margin-left:40px;" value="Tambahkan Ke Keranjang" />
										</div>
										</form>
                                    </div>
                ...
                <div class="modal-body cart-addon">
                    <div class="food-item white">
                        <div class="row">
                            ...
                            <div class="col-xs-6 col-sm-2 col-lg-2 text-xs-center"> <span class="price pull-left">Rp. 2.99</span></div>
                    ...
                    <div class="food-item">
                        <div class="row">
                            ...
                            <div class="col-xs-6 col-sm-2 col-lg-2 text-xs-center"> <span class="price pull-left">Rp. 2.49</span></div>
                            <div class="col-xs-6 col-sm-4 col-lg-4">
                                <div class="row no-gutter">
                                    <div class="col-xs-7">
                    ...
                    <div class="food-item">
                        <div class="row">
                            ...
                            <div class="col-xs-6 col-sm-2 col-lg-2 text-xs-center"> <span class="price pull-left">Rp. 1.99</span></div>
                            <div class="col-xs-6 col-sm-4 col-lg-4">
                                <div class="row no-gutter">
                                    <div class="col-xs-7">
                    ...
                    <div class="food-item">
                        <div class="row">
                            ...
                            <div class="col-xs-6 col-sm-2 col-lg-2 text-xs-center"> <span class="price pull-left">Rp.  3.15</span></div>
                            <div class="col-xs-6 col-sm-4 col-lg-4">
                                <div class="row no-gutter">
                                    <div class="col-xs-7">
