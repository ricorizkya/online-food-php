        ...
        <section class="hero bg-image" data-image-src="images/img/BG.jpg">
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    <h1>Selamat Datang di Toko <h1><br>
                    <h1> UD MINA MAKMUR </h1>
                    ...
                    <div class="steps">
                        <div class="step-item step1">
                            ...
                            <h4><span style="color:white;">1. </span>UD MINA MAKMUR</h4> </div>
                        ...
                        <div class="step-item step2">
                            ...
                            <h4><span style="color:white;">2. </span>PESAN MENU</h4> </div>
                        ...
                        <div class="step-item step3">
                            ...
                            <h4><span style="color:white;">3. </span>PENGANTARAN</h4> </div>
        ...
        <section class="popular">
            <div class="container">
                <div class="title text-xs-center m-b-30">
                    <h2>Favorit Untuk Bulan Ini</h2>
                    <p class="lead">Cara termudah untuk memesan makanan favorit Anda di antara 6 hidangan teratas ini</p>
                </div>
                <div class="row">
						<?php 					
                                    ...
                                    echo '  <div class="col-xs-12 col-sm-6 col-md-4 food-item">
                                            <div class="food-item-wrap">
                                                ...
                                                <div class="content">
                                                    ...
                                                    <div class="price-btn-block"> <span class="price">Rp. '.$r['price'].'</span> <a href="dishes.php?res_id='.$r['rs_id'].'" class="btn theme-btn-dash pull-right">Pesan Sekarang</a> </div>
                                                </div>
                    ...
                    <div class="row how-it-works-solution">
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                            <div class="how-it-works-wrap">
                                <div class="step step-1">
                                    ...
                                    <h3>Toko Kami</h3>
                                    <p>Kami menyediakan menu untuk Anda dari Toko UD MINA MAKMUR.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col2">
                            <div class="step step-2">
                                ...
                                <h3>Menerima Berbagai Menu</h3>
                                <p>Kami siap menerima pesanan Anda dengan berbagai menu ditoko kami UD MINA MAKMUR .</p>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col3">
                            <div class="step step-3">
                                ...
                                <h3>Ambil Sendiri atau Diantar</h3>
                                <p>Antar Pesanan Anda! Dan nikmati makanan Anda! </p>
                            </div>
                        </div>
                    </div>
                </div>
